...
open class BaseSwipeFragment : RxFragment(), ISwipeBackFragment, ISupportFragment {
    val mDelegate2 = SwipeBackFragmentDelegate(this)

    override fun onCreate(@Nullable savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mDelegate2.onCreate(savedInstanceState)
    }

    override fun onViewCreated(view: View, @Nullable savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        mDelegate2.onViewCreated(view, savedInstanceState)
    }

    override fun attachToSwipeBack(view: View): View {
        return mDelegate2.attachToSwipeBack(view)
    }

    override fun getSwipeBackLayout(): SwipeBackLayout {
        return mDelegate2.swipeBackLayout
    }
    ...
    override fun setSwipeBackEnable(enable: Boolean) {
        mDelegate2.setSwipeBackEnable(enable)
    }

    override fun setEdgeLevel(edgeLevel: SwipeBackLayout.EdgeLevel) {
        mDelegate2.setEdgeLevel(edgeLevel)
    }

    override fun setEdgeLevel(widthPixel: Int) {
        mDelegate2.setEdgeLevel(widthPixel)
    }
    ...
    override fun setParallaxOffset(@FloatRange(from = 0.0, to = 1.0) offset: Float) {
        mDelegate2.setParallaxOffset(offset)
    }
