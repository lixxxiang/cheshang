...
public class RecordDao extends AbstractDao<Record, Long> {
    ...
    public static class Properties {
        ...
        public final static Property RealTime = new Property(4, String.class, "realTime", false, "REAL_TIME");
        public final static Property IsToday = new Property(5, String.class, "isToday", false, "IS_TODAY");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECORD\" (" + //
                ...
                "\"REAL_TIME\" TEXT," + // 4: realTime
                "\"IS_TODAY\" TEXT);"); // 5: isToday
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Record entity) {
        ...
        String realTime = entity.getRealTime();
        if (realTime != null) {
            stmt.bindString(5, realTime);
        }
 
        String isToday = entity.getIsToday();
        if (isToday != null) {
            stmt.bindString(6, isToday);
        }
    }
    ...
    public Record readEntity(Cursor cursor, int offset) {
        Record entity = new Record( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // realTime
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5) // isToday
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Record entity, int offset) {
        ...
        entity.setRealTime(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setIsToday(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
     }
