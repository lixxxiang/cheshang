...
import com.android.lixiang.cheshang.presenter.OCRInsertPresenter
import com.android.lixiang.cheshang.presenter.data.bean.AddLicenseBean
import com.android.lixiang.cheshang.presenter.injection.component.DaggerOCRInsertFragmentComponent
...
import kotlinx.android.synthetic.main.fragment_ocr_insert.*
...
class OCRInsertFragment :
        BaseMvpFragment<OCRInsertPresenter>()
        , View.OnClickListener
        , OCRInsertView {
    override fun injectComponent() {
        DaggerOCRInsertFragmentComponent.builder().fragmentComponent(fragmentComponent).oCRInsertModule(OCRInsertModule()).build().inject(this)
    ...
    override fun onClick(v: View?) {
        when (v) {
            ...
            mConfirmBtn -> {
                ...
                if (!mNameET.text.toString().isEmpty() &&
                        !mTelET.text.toString().isEmpty() &&
                        !mPlateNumberET.text.toString().isEmpty() &&
...
//                start(StoreFragment().newInstance())
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_ocr_insert, container, false)
    }
...
//            mNameET.setText("请输入持证人姓名")
    ...
    fun newInstance(): OCRInsertFragment {
        val args = Bundle()
        val fragment = OCRInsertFragment()
