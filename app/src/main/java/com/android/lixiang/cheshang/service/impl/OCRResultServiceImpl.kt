...
class OCRResultServiceImpl @Inject constructor() : OCRResultService {
    override fun addLicense(hrAccount: String, p2: String, p3: String, hrAccount2: String, p4: String, p5: String, hrAccount3: String, p6: String, hrAccount4: String, p7: String, hrAccount5: String, param12: String, param13: String, param14: String): Observable<AddLicenseBean> {
        return mOCRResultRepository.addLicense(hrAccount, p2, p3, hrAccount2, p4, p5, hrAccount3, p6, hrAccount4, p7, hrAccount5, param12, param13, param14).flatMap(Function<AddLicenseBean, ObservableSource<AddLicenseBean>> { t ->
    ...
    @Inject
    lateinit var mOCRResultRepository: OCRResultRepository
}