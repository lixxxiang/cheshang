...
public class CarStoreAdapter extends BaseAdapter {
    ...
    public CarStoreAdapter(List<String> mTitleList, List<String> mDetailList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.mCarStoreCheckIV = convertView.findViewById(R.id.mCarStoreCheckIV);
        ...
        if (position == selectedItem) {
            holder.mCarStoreCheckIV.setVisibility(View.VISIBLE);
        }
        return convertView;
    }
    ...
    final class ViewHolder {
        ...
        AppCompatImageView mCarStoreCheckIV;
    }
}
